...
function submitHandler(event){
  ...
  return (
    <form onSubmit={submitHandler} className="flex flex-col w-full gap-y-4 mt-6 h-[320px]" >
        <label className='w-full'>
            <p className='text-[0.875rem] text-richblack-5 mb-1 leading-[1.375rem]'>Email id
